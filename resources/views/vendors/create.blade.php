<x-layouts::app :title="__('Add Vendor')">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <flux:heading size="xl" class="font-extrabold">
                Add <span class="text-accent">Vendor</span>
            </flux:heading>
            <flux:text class="mt-0.5 text-zinc-400">Create a new vendor with contact details and SLA terms.</flux:text>
        </div>
    </div>
