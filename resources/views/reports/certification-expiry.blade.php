...
<x-layouts::app title="Certification Expiry Report">
    ...
    <div class="mb-5 flex items-center justify-between flex-wrap gap-3">
        <div>
            ...
            <flux:text class="text-zinc-400 mt-1">Inspection & compliance certification expiry dates from service records.</flux:text>
        </div>
            ...
            <tbody class="divide-y divide-zinc-800">
                @forelse ($records as $svc)
                    @php
                        ...
                        $cls = $expired ? 'text-red-400 font-semibold' : ($soon ? 'text-orange-400' : 'text-zinc-200');
                    @endphp
