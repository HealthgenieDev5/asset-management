...
<x-layouts::app title="Warranty Expiry Report">
    ...
    <div class="mb-5 flex items-center justify-between flex-wrap gap-3">
        <div>
            ...
            <flux:text class="text-zinc-400 mt-1">Original manufacturer warranty expiry dates.</flux:text>
        </div>
            ...
            <tbody class="divide-y divide-zinc-800">
                @forelse ($assets as $asset)
                    ...
                    <tr class="hover:bg-accent/5">
                        ...
                        <td class="px-4 py-2.5 text-zinc-400 text-xs max-w-48 truncate">{{ $asset->warranty_details ?: '—' }}</td>
