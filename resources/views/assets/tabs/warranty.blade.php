...
<div class="space-y-5">
    ...
    <div class="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
        ...
        <dl class="grid gap-x-6 gap-y-4 sm:grid-cols-2">
            <div class="sm:col-span-2">
                ...
                <dd class="mt-1 text-sm text-zinc-200">{{ $asset->warranty_details ?: '—' }}</dd>
            </div>
            <div>
                ...
                <dd class="mt-1 text-sm">
                    @if ($asset->warranty_lapse_date)
                        ...
                        <span class="{{ $expired ? 'text-red-400 font-semibold' : 'text-zinc-200' }}">
    ...
    <div class="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
        <div class="mb-4 flex items-center justify-between">
            <flux:heading class="font-semibold text-zinc-300">Warranty Documents</flux:heading>
