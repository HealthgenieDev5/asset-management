        ...
        <div class="space-y-4">
            @foreach ($asset->services->sortByDesc('service_date') as $svc)
                ...
                <div class="rounded-xl border border-zinc-200 bg-white overflow-hidden dark:border-zinc-800 dark:bg-zinc-900">
                    {{-- Card Header --}}
                    <div class="flex items-center justify-between gap-3 bg-zinc-50 px-5 py-3 dark:bg-zinc-800/40"
                         :class="editId === {{ $svc->id }} ? '' : 'border-b border-zinc-200 dark:border-zinc-800'">
