    ...
    @else
        ...
        <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
            <div class="mb-4 flex items-center justify-between">
                <flux:heading class="font-semibold text-zinc-700 dark:text-zinc-300">Extended Warranty Details</flux:heading>
            ...
            <dl class="grid gap-x-6 gap-y-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div>
                    ...
                    <dd class="mt-0.5 text-sm">
                        @if ($ew->extended_warranty_date_to)
                            ...
                            @endphp
                            <span class="{{ $expired ? 'text-red-400 font-semibold' : ($soon ? 'text-yellow-400' : 'text-zinc-800 dark:text-zinc-200') }}">
                ...
                @if ($ew->extended_warranty_terms)
                    <div class="sm:col-span-2 lg:col-span-2">
                        ...
                        <dd class="mt-0.5 text-sm text-zinc-800 whitespace-pre-line dark:text-zinc-200">{{ $ew->extended_warranty_terms }}</dd>
                    </div>
                @endif
        ...
        <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
            <div class="mb-4 flex items-center justify-between">
                <flux:heading class="font-semibold text-zinc-700 dark:text-zinc-300">Extended Warranty Documents</flux:heading>
