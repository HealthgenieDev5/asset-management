    ...
    foreach ($asset->maintenanceSchedules->where('is_active', true) as $schedule) {
        ...
        if ($schedule->schedule_type === 'date') {
            $pushDateItem(
                ...
                $schedule->reminder_thresholds ? max($schedule->reminder_thresholds) : 30,
                'schedules',
                'calendar-days',
                $scheduleMeta,
                'View Schedule'
            ...
            $pushUnitItem(
                ...
                'km',
                $schedule->reminder_thresholds ? max($schedule->reminder_thresholds) : 500,
                'schedules',
                'chart-bar',
                $scheduleMeta,
                'View Schedule'
            ...
            $pushUnitItem(
                ...
                'hrs',
                $schedule->reminder_thresholds ? max($schedule->reminder_thresholds) : 50,
                'schedules',
                'clock',
                $scheduleMeta,
                'View Schedule'
